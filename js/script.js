...
function getLocation(position) {
    ...
    $.getJSON(url, function (json) {
            ...
            case '02d':
                    ...
                    break;
            case '02n':
                    $('body').css('background-image', 'url("https://source.unsplash.com/?night,cloud")');
                break;
            case '03d':
            case '03n':
                    $('body').css('background-image', 'url("https://source.unsplash.com/?cloud")');
                break;
            case '04d':
            case '04n':
                    $('body').css('background-image', 'url("https://source.unsplash.com/?dark,cloud")');
                break;
            case '09d':
            case '09n':
            case '10d':
            case '10n':
                    $('body').css('background-image', 'url("https://source.unsplash.com/?rain")');
                break;
            case '11d':
            case '11n':
                    $('body').css('background-image', 'url("https://source.unsplash.com/?storm")');
                break;
            case '13d':
            case '13n':
                    $('body').css('background-image', 'url("https://source.unsplash.com/?snow")');
                break;
            case '50d':
            case '50n':
                    $('body').css('background-image', 'url("https://source.unsplash.com/?fog")');
                break;
            }
        }
